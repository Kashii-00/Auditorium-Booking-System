    ...
    try {
      ...
      try {
        await sendEmail({
          ...
          userType: 'lecturer', // Add user type for email control
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
              ...
              <p>To access your account, please visit: <a href="${process.env.CLIENT_URL || 'https://mpmaerp.slpa.lk'}/lecturer-login" style="color: #3b82f6;">Lecturer Portal</a></p>
