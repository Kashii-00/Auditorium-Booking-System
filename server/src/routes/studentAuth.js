      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
          ...
          <div style="text-align: center; margin-top: 30px;">
            <a href="${process.env.CLIENT_URL || 'https://mpmaerp.slpa.lk'}/student-login" style="background-color: #1e40af; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">Login to Student Portal</a>
          </div>
