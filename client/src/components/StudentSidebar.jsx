          ...
          >
            ...
            >
              {isOpen ? (
                ...
                <PanelLeftOpen className="w-4 h-4 text-gray-600 group-hover:text-blue-600" />
              )}
            </motion.div>
          </Button>
        </motion.div>
              ...
              {isOpen ? (
                ...
                >
                  ...
                  <div className="relative mb-6">
                    <div className="h-24 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-xl"></div>
