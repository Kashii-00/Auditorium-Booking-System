    ...
    try {
      ...
      if (!batch?.course_id) {
        ...
        return
              ...
              const availableStudents = await authRequest("get", getApiUrl(`/batches/${id}/available-students`))
  ...
  const addStudentsToBatch = useCallback(async () => {
    ...
    try {
      ...
      setError("")
              ...
              const response = await authRequest("post", getApiUrl(`/batches/${id}/students`), {
