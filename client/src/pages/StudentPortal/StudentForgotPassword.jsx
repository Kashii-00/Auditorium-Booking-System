  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        getApiUrl("/student-auth/forgot-password"),
        { email }
      );
                  ...
                  >
                    {isLoading ? (
                      <div className="flex items-center">
                        <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="httpss://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
