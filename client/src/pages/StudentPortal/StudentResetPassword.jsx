...
const StudentResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5003/api/student-auth/reset-password",
        {
          token: token,
        ...
        <div className="w-full max-w-md">
          <div className="bg-white/90 backdrop-blur-lg shadow-xl rounded-2xl overflow-hidden border border-slate-200">
            <div className="bg-gradient-to-r from-red-600 to-red-600 p-6 text-white text-center">
              ...
              <p className="text-red-100 mt-1">SLPA Training Institute</p>
            </div>
            <div className="p-6 text-center">
              ...
              <Link
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-[1.02]"
              >
  ...
  return (
    <motion.div
      className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center p-4 md:p-6"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 text-center">
          <Link to="/?type=student" className="text-sm text-slate-600 hover:text-blue-600 font-medium flex items-center justify-center">
